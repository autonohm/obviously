...
public:
	...
	// ---> SETTER
	void setInitTransformation(const obvious::Matrix initMatrix);
	/**
	 * Function to set threshold for all translation degrees of freedom
	 * @param 	translationTH		threshold in meters
	 */
	void setTranslationThreshold(  double translationTH);
//	/**
...
//	void setTranslationThresholdZ( const double* translationTH_z);
	 ...
	 */
	void setRotationThreshold(     double rotationTH);
//	/**
...
//	void setRotationThresholdYaw(  const double* rotationTH_yaw);
	 ...
	 */
	bool checkWatchdog(obvious::Matrix newTransformation);
private:
